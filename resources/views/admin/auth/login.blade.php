...
<head>
    ...
    <title>Admin Login - Medicenter</title>
...
<body class="bg-slate-50 text-slate-800 antialiased relative min-h-screen flex flex-col overflow-hidden">
        ...
        <div class="w-full max-w-md animate-fade-in-up">
            ...
            <div class="flex flex-col items-center justify-center gap-3 mb-8">
                ...
                <div class="text-center">
                    ...
                    <p class="text-slate-500 font-medium mt-1">Admin Dashboard</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2rem] shadow-2xl shadow-brand-900/5 border border-slate-100 p-8 sm:p-10">
                ...
                <p class="text-slate-500 text-sm mb-8">Sign in to manage your clinic queue and appointments.</p>
                ...
                <form method="POST" action="{{ route('admin.login') }}" class="space-y-5">
                    ...
                    <div class="flex items-center pt-1">
                        ...
                        <label for="remember" class="ml-2 text-sm font-medium text-slate-600 cursor-pointer select-none">Remember my device</label>
                    </div>
                ...
                <div class="text-center">
                    <p class="text-slate-500 text-sm">
                        Need admin access? 
                        <a href="/admin/register" class="text-brand-600 hover:text-brand-700 font-semibold transition-colors">Create Account</a>
                    </p>
                </div>
            </div>
            ...
            <div class="mt-8 flex items-center justify-center gap-2 text-slate-400 text-xs font-medium" style="animation-delay: 0.2s;">
                ...
                <span>Secure, encrypted administration portal.</span>
            </div>
        </div>
    </div>

    <!-- Footer -->
    <footer class="relative z-10 py-6 text-center text-slate-500 text-xs">
